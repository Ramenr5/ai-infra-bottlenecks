...
## [2026-06-03] verify+ingest | AAOI optical-transceiver thesis + EML laser chokepoint
- user: verify AAOI thesis (800G/1.6T demand, US capacity/vertical integration, AMD/NVDA rumors, EML bottleneck, ASP/margin upside)
- VERIFIED: US capacity (100k→500k/mo by end-26, 900k sqft, laser +350%, <10% China) ✓; 800G demand 24M→63M units 2026 ✓; $324M backlog + first 1.6T volume order ✓; **EML bottleneck ✓✓ (NVIDIA $4B Lumentum+Coherent lockup, lead times past 2027 — "NVDA starts first, bottlenecks everyone" exactly right)**; ASP decline consensus ✓ ($1200→$400, GM<25%).
- CORRECTION: AMD/NVDA conversations = RUMOR; NVIDIA's named optical partners are Lumentum ($2B)+Coherent, NOT AAOI. AAOI = hyperscaler-direct + vertically integrated.
- SHARPENED: AAOI's own-laser vertical integration = a structural HEDGE vs the NVIDIA-locked merchant EML supply; the bottleneck→ASP-firming variant perception is legitimate + under-modeled (margin upside across AAOI/LITE/COHR/FN).
- created [[Applied Optoelectronics]]; added **EML laser chokepoint** section to [[Networking & interconnect]] (NVIDIA $4B EML lockup, 800G/1.6T demand, ASP variant perception, AAOI vertical-integration hedge). index +AAOI. VERIFY.
