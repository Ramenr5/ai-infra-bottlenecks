...
- [[onsemi]] (ON) — **SiC/GaN; NVIDIA 800VDC collaboration + expanded MGX role**; power-semi content per 1 MW AI rack **doubled $50k→$100k**; AI-DC +30% sequential Q1'26. But a **large auto/industrial core** (cyclical) dilutes the AI signal vs the pure-plays.
