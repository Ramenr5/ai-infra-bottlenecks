...
| --- | --- | --- |
| **Tier 1 — upstream of both forks (cleanest)** | wins under any compute vendor *and* any architecture | **[[TSMC]]** (foundry; everyone prints there) · **HBM** ([[SK Hynix]]/[[Micron Technology]]/[[Samsung Electronics]]) · **[[Advanced packaging & OSAT (the AI packaging toll)|advanced packaging / CoWoS]]** ([[BESI]] hybrid bonding, [[ASE Technology]]/[[Amkor]] OSAT, +[[KLA Corporation]]) · **[[Semiconductor test (the AI test toll)|test]]** ([[Advantest]]/[[Teradyne]]/[[FormFactor]]) · **EDA** ([[Synopsys]]/[[Cadence Design Systems]]) · **lithography** ([[Lithography monopoly\|ASML]] + **[[Lasertec]]** EUV-inspection monopoly) · **[[WFE & process control (the equipment toll)|WFE/process-control]]** (cyclical) |
